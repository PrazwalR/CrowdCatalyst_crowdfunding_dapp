        ...
        <div className="relative px-4 py-16 mx-auto overflow-hidden sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="flex flex-col items-center justify-between xl:flex-row">
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
              ...
              CrowdCatalyst <br className="hidden md:block" /> Crowd Funding CC </h2>
            
              <p className="max-w-xl mb-4 text-base text-gray-200 md:text-lg">
              Welcome to CrowdCatalyst — where visionaries meet believers. Whether you're launching the next big innovation, supporting a meaningful cause, or funding a creative dream, we're here to spark your journey.
              Start a campaign. Back a dream. Be the catalyst.
              </p>
              <a
                href="/"
                aria-label=""
              ...
              <div className="mb-1 sm:mb-2">
                ...
                <div className="mb-1 sm:mb-2">
                  ...
                  <p className="text-xs text-gray-600 sm:text-sm">
                    Create your Campaign for raising Funds
                  </p>
              </form>
            </div>
          </div>  
